...
BINARIES := bin/lighthouse-agent bin/lighthouse-coredns bin/mcshub
IMAGES := lighthouse-agent lighthouse-coredns mcshub
...
package/.image.mcshub: bin/mcshub
...
bin/mcshub: vendor/modules.txt $(shell find pkg/mcshub/controller)
	${SCRIPTS_DIR}/compile.sh $@ ./pkg/mcshub $(BUILD_ARGS)
